...
class TestWriteLog:
    def test_creates_log_file(self, tmp_path):
        topic_dir = tmp_path / "2026-05-20-14-30-test"
        topic_dir.mkdir()

        result = write_log(
            "2026-05-20-14-30-test", "hello world", tmp_path,
    ...
    def test_log_content_format(self, tmp_path):
        ...
        write_log(
            "2026-05-20-14-30-test", "my prompt", tmp_path,
            timestamp="2026-05-20T10:00:00+08:00",
        )
    ...
    def test_appends_to_existing_log(self, tmp_path):
        ...
        write_log("2026-05-20-14-30-test", "first", tmp_path, timestamp="T1")
        write_log("2026-05-20-14-30-test", "second", tmp_path, timestamp="T2")
    ...
    def test_topic_dir_not_exist(self, tmp_path):
        with pytest.raises(FileNotFoundError, match="does not exist"):
            write_log("2026-05-20-14-30-missing", "hello", tmp_path)
    ...
    def test_empty_content(self, tmp_path):
        ...
        with pytest.raises(ValueError, match="no input provided"):
            write_log("2026-05-20-14-30-test", "", tmp_path)
